...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" Runat="Server">
    ...
    <div class="container">
        ...
        <asp:CustomValidator CssClass="form-text error-message" ID="loginFailedValidator" runat="server" ErrorMessage="Login failed" Display="Dynamic"></asp:CustomValidator>
    </div>
